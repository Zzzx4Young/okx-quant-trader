...
| ~~**B**~~ | ~~`BB_RSI_REVERSION`~~ | ~~震荡市左侧~~ | ⚠️ **已永久禁用 v1.8.3+ (2026-07-20)**：BTC 1h 17 月 baseline WR=27.8% (36 trades), ret=-24.02%, Sharpe=-1.311, MaxDD=33.82%。v1.8 Fix A (EMA50/EMA200 趋势过滤) 后仍不达标。Kelly f_full 永久负值。代码保留作历史参考（重启用需重新验证）。 |
...
| ~~B_BB_RSI_REVERSION~~ | ~~-37.16%~~ | ~~-1.950~~ | ~~30~~ | ⚠️ **已永久禁用 v1.8.3+ (2026-07-20)**：详见策略表 v1.8.3+ note |

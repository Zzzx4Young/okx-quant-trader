...
> **版本 v1.8.1** · 基于 OKX API v5 · 307/307 测试通过（其中核心 145+）· 4 策略 + Constitution + 跨策略过滤 + 摩擦校准 + K 线驱动调度

[![Python](https://img.shields.io/badge/Python-3.8%2B-blue)](https://www.python.org/)
[![Version](https://img.shields.io/badge/version-1.8.1-orange)](okx/__init__.py)
[![Tests](https://img.shields.io/badge/tests-307%2F307-brightgreen)](tests/)
...
| **307 单测** | pytest 全过（32 个 §3 冲突过滤 + 2 个 calibration + Constitution 配置 + A+C double-lock 回归） |
